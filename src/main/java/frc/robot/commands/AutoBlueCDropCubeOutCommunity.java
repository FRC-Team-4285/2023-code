...
public class AutoBlueCDropCubeOutCommunity extends CommandBase {
  /*
   * Autonomous Command
   * ------------------
   * 
   ...
   */
    ...
    public AutoBlueCDropCubeOutCommunity(SwerveBase swerveBase, PickupArmBase pickupArmBase, SuctionArmBase suctionArmBase) {
        drive = swerveBase;
