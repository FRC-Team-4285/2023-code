...
public class AutoRedCDropCubeGrabCone extends CommandBase {
    ...
    public AutoRedCDropCubeGrabCone(SwerveBase swerveBase, PickupArmBase pickupArmBase, SuctionArmBase suctionArmBase, IntakeBase intakeArmBase) {
        drive = swerveBase;
    ...
    public void execute() {
        ...
        // else if (timeSinceInitialized < 8250) { 
        //     drive.drive(0.0, 0.0, 0.0, true);
        //     armBase.go_to_position(ArmConstants.FEEDER_POS);
        //     armBaseIntake.grab_cone();
        // }    
        // else if (timeSinceInitialized < 8650) { 
        //      drive.drive(0.0, 0.0, 0.0, true);
        ...
        // }    
        // else if (timeSinceInitialized < 8850) { 
        //      drive.drive(0.0, 0.0, 0.0, true);
        //      armBase.go_to_position(ArmConstants.FEEDER_POS);
        //      armBaseCone.grab_cone();
        ...
        // else if (timeSinceInitialized < 13000) { //Was 13000 changed for Amanda
