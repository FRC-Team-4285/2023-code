...
public class AutoBDropCubeOnBalanceTest extends CommandBase {
   ...
   private final SuctionArmBase armBaseCone;
    ...
    public AutoBDropCubeOnBalanceTest(SwerveBase swerveBase, PickupArmBase pickupArmBase, SuctionArmBase suctionArmBase) {
        drive = swerveBase;
