...
public class AutoRedCDropCubeOutCommunity extends CommandBase {
  /*
   * Autonomous Command
   * ------------------
   * 
   ...
   */
    ...
    public AutoRedCDropCubeOutCommunity(SwerveBase swerveBase, PickupArmBase pickupArmBase, SuctionArmBase suctionArmBase) {
        drive = swerveBase;
    ...
    public void execute() {
        ...
        else if (timeSinceInitialized < 5500) {//was 6500
